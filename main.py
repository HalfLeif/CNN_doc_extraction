...
def sweQueue(batch_size, train_mode):
    print('Load transcriptions')
    if train_mode:
        all_jpgs, all_years = swe.loadTrainingSet()
    else:
        all_jpgs, all_years = swe.loadTestSet()
...
def trainOp(pretrain=True):
    if pretrain:
        ...
        batch_images, batch_years = sweQueue(SWE_BATCH_SIZE, True)
...
def evalOp(pretrain=True):
    ...
    if pretrain:
        ...
        batch_images, batch_years = sweQueue(SWE_BATCH_SIZE, False)
